...
export const CATALOG_PRINTIFY_NOTE =
  "The catalog is seven Printify products: five wall-art mixes plus black-camo men’s and Southern Cross women’s mesh sneakers. Etsy, Shopify, and the website Catalog dropdowns use the same mix: All, Quotes, Botanical, Scenic, Home décor, Original fern. Do not migrate leftover External products. Gelato stays for EU/UK wall art; mesh sneakers print on Printify (Smart Printee).";
